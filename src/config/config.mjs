import { isEmpty } from '../utils/validate_env.utils.mjs'
...
const __config = {
	...
	SALTROUNDS	: process.env.SALTROUNDS ? parseInt(process.env.SALTROUNDS, 10) : undefined,
}
...
export async function validate_config() {
	...
	return await Promise.all(validationPromises)
		.then((result) => {
			...
			console.log('[ system ] Configuration validation passed successfully.')
		})
	.catch((error) => {
